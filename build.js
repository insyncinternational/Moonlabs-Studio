...
function buildProject() {
    console.log('🚀 Building Moonlabs Studio for deployment...');
...
<head>
    ...
    <title>Moonlabs Studio - Building the Future of AI from Dubai</title>
    <meta name="description" content="Moonlabs Studio is a venture builder in the UAE that transforms visionary founders into CEOs of high-growth AI companies.">
    <meta name="keywords" content="AI, venture builder, startup, Dubai, UAE, artificial intelligence, entrepreneurship">
    <meta property="og:title" content="Moonlabs Studio - Building the Future of AI">
    ...
    <meta property="og:url" content="https://moonlabs.studio">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Moonlabs Studio - Building the Future of AI">
    ...
    <section class="hero">
        <div class="hero-container">
            <div class="hero-content">
                ...
                <p class="hero-subheadline">Moonlabs Studio is a venture builder in the UAE that transforms visionary founders into CEOs of high-growth AI companies. We provide the team, the capital, and the ecosystem to turn your idea into reality.</p>
        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-section">
                    <h4>Contact</h4>
                    <p>Dubai, UAE</p>
                    <p>hello@moonlabs.studio</p>
                </div>
            </div>
            <div class="footer-bottom">
                <p>&copy; 2024 Moonlabs Studio. All rights reserved.</p>
            </div>
        </div>
    </footer>
